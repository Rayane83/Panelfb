...
const BlanchimentTab = () => {
  ...
  const calculateDuration = (dateRecu: string, dateRendu: string) => {
  ...
  const addNewRow = () => {
    ...
    const row = {
      id: `new-${Date.now()}`,
      ...newRow,
      somme: parseFloat(newRow.somme.toString()) || 0,
...
const SimpleTab = ({ title, description, icon: Icon, specs }: { title: string, description: string, icon: any, specs?: string[] }) => (
  <div className="space-y-6">
    <div>
